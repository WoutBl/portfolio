  ...
  <section id="ME" className=" h-[70vh]  flex justify-around items-center">
    ...
    <div className="flex flex-col text-secondary-purple items-start justify-center w-1/2 ">
      ...
      <p className="">
        ...
        is always eager to learn new things and always wants to achieve his goals.
      </p>
    </div>
  </section>
</template>
...
.maskedImageContainer {
  width: 300px;
  height: 300px;
  border-radius: 10px; /* Make the container round */
  overflow: hidden; /* Clip the image to the container's rounded shape */
}
</style>
